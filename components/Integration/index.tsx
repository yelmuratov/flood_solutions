      ...
      <section>
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <SectionHeader
            headerInfo={{
              title: `INTEGRATSIYA`,
              subtitle: `Ma'lumotlaringizni istalgan joydan, istalgan vaqtda masofadan boshqaring.`,
              description: `FLOOD Solutions sizga yuqori sifatli IT xizmatlarini taqdim etadi: veb-saytlar, mobil ilovalar, CRM tizimlari, ERP, sun'iy intellekt va Telegram botlar. Bizning integratsiya xizmatlarimiz orqali siz ma'lumotlaringizni samarali va oson boshqarishingiz mumkin.`,
            }}
          />
          {/* <!-- Section Title End --> */}
        </div>
